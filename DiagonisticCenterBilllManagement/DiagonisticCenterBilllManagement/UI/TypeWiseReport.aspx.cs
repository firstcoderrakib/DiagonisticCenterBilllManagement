...
namespace DiagonisticCenterBilllManagement.UI
{
    public partial class TypeReport : System.Web.UI.Page
    {
        ...
        private void ExportGridToPDF()
        {
            ...
            sb.Append("<tr><td align='center' colspan = '3' style='background-color: #18B5F0;color:Red;' colspan = '2'></br><b><h3>Type Wise Bill Riport</h3></b></td></tr></table>");
            ...
            Response.AddHeader("content-disposition", "attachment;filename=TypeWiseBillReport.pdf");
